...
public class menuSPL {
    ...
    public static void SPLCramer(matriks m) {
        if(m.cols == m.rows + 1){
            ...
            System.out.println("Metode SPL dengan Crammer hanya bisa menjalankan SPL dengan ukuran matriks augmented n x (n+1). Silahkan gunakan metode Gauss atau Gauss Jordan untuk menyelesaikan permasalahan anda.");
        }
